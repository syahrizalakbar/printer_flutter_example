...
class PrinterThermal extends StatefulWidget {
  @override
  _PrinterThermalState createState() => _PrinterThermalState();
}

class _PrinterThermalState extends State<PrinterThermal> {
